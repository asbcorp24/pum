...
void glue_get_rs485(struct rs485 *);
void glue_set_rs485(struct rs485 *);

struct uchet {
  double kf;
};
void glue_get_uchet(struct uchet *);
void glue_set_uchet(struct uchet *);

struct rest {
  char token[20];
  char url[100];
};
void glue_get_rest(struct rest *);
void glue_set_rest(struct rest *);
